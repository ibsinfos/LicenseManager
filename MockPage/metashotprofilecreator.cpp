...
//    this->ui->overlayImageSizeLabel->setVisible(false);
    ...
    this->m_uaList.append("Mozilla/5.0 (Windows NT 6.1; WOW64; rv:49.0) Gecko/20100101 Firefox/49.0");
    ...
    this->ui->userAgentInput->setText("Mozilla/5.0 (Windows NT 6.1; WOW64; rv:49.0) Gecko/20100101 Firefox/49.0");
