...
<head>
    ...
    <title><?php echo PRODUCT_NAME;?> JS Obfuscator</title>
                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <?php
                            $apiquery = file_get_contents(PHPMYLICENSE_API.'/user/getpermission?service=jsencoder&purchasecode='.$purchasecode);
                            $apiresponse = json_decode($apiquery, true);
                            if($apiresponse['allowed'] == false)
                            {
                                ?>
                                <div class="alert alert-block alert-danger fade in" id="msgError">
                                    ...
                                    <strong>Oh snap!</strong> <div id="msgError_Text"><?php echo $apiresponse['message'];?></div>
                                </div>
                            <?php
                            }else{
                            ?>
                            ...
                            <form role="form" id="frmObfuscate">
                                <div class="form-group">
                                    <label for="txtObfuscate">Javascript to Obfuscate</label>
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if(result.status == 200)
                    {
                        ...
                        $("#frmResult").fadeIn();
                        $("#obfuscated").val(base64_decode(result.jscode));
                        $("#btnSubmit").hide();
                    }else{
