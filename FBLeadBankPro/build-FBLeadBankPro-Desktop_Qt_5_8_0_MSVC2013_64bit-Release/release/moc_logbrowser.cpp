...
#include "../../FBLeadBankPro/logbrowser.h"
...
void LogBrowser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addLog((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject LogBrowser::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LogBrowser.data,
