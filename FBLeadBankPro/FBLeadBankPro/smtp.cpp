    ...
    if(!files.isEmpty())
    {
        ...
        foreach(QString filePath, files)
        {
            ...
            if(file.exists())
            {
                ...
                int w = settings.value("EMAIL_IMAGE_WIDTH").toInt();
                int h = settings.value("EMAIL_IMAGE_HEIGHT").toInt();
                ...
                message.append("MIME-Version: 1.0\n");
                message.append("Content-ID: <image1>\n");
                message.append("Content-Transfer-Encoding: base64\n\n");
                message.append(nbytes.toBase64());
                message.append("\n");
            }
        }
    }
